...
public class ValidadorExistenEntidades extends ValidadorBase {
    ...
    public ValidadorExistenEntidades(FormateadorResultadosPort formateadorResultados,
    ...
    protected boolean manejarValidacion(FranjaHoraria franjaHoraria) {
        EspacioFisico espacioFisico = franjasGateway
                .getEspacioFisicoById(franjaHoraria.getEspacioFisico().getEspacioFisicoId());
        if (espacioFisico == null) {
            formateadorResultados.retornarRespuestaErrorEntidadNoExisteI18n("franjaHoraria.espacioFisico.noExiste");
            return false;
        }
         ...
         * franjasFormateadorResultados.
         * retornarRespuestaErrorEntidadNoExiste("No existe el docente con id" +
        ...
        if (curso == null) {
            formateadorResultados.retornarRespuestaErrorEntidadNoExisteI18n("franjaHoraria.curso.noExiste");
            return false;
        }
